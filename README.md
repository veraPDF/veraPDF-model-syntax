...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.31/job/model-syntax/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.31/job/model-syntax/ "OPF Jenkins")
