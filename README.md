...
[![Build Status](https://jenkins.openpreservation.org/job/veraPDF/job/1.30rc/job/model-syntax/badge/icon)](https://jenkins.openpreservation.org/job/veraPDF/job/1.30rc/job/model-syntax/ "OPF Jenkins")
